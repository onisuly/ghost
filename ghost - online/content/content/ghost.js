...
function ghost() {};
var refD = "http://playbeta.net/swf/";
...
ghost.prototype = {
    SITES: {
        ...
        'iqiyi': {
            ...
            're': /https?:\/\/www\.iqiyi\.com\/(player\/\d+\/Player|common\/flashplayer\/\d+\/(Main|Coop|share|Enjoy)?(Player[^\.]*|\d+(1af8f6df|f98c2359|5b45a8bb)))\.swf/i
        },
        'tudou': {
